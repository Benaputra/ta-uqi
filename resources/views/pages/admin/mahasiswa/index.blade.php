                ...
                <form method="post" id="sample_form" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nim" placeholder="Nomor Induk Mahasiswa" id="nim" class="form-control" />
                        </div>
                        <div class="form-group">
                            <label>Nama Mahasiswa : </label>
                            <input type="text" name="name" placeholder="Nama Mahasiswa" id="name" class="form-control" />
                        </div>
                        <div class="form-group">
                            <label>Kelas : </label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" placeholder="Email Mahasiswa" id="email" class="form-control" />
                        </div>
